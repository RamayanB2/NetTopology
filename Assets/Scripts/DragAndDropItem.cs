...
public class DragAndDropItem : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    private bool displayedItensNames;
    ...
    {
        if (itemController.isShowingItemText && !displayedItensNames) {
            DisplayItemName();
            displayedItensNames = true;
        } else if (!itemController.isShowingItemText && displayedItensNames) {
            HideItemName();
        }
    }
    /// <summary>
    ...
    public void DisplayItemName(){
        ...
        if (itemController.isColorBlack) this.GetComponentInChildren<UnityEngine.UI.Text>().color = Color.black;
        else if(!itemController.isColorBlack) this.GetComponentInChildren<UnityEngine.UI.Text>().color = Color.white;
        this.GetComponentInChildren<UnityEngine.UI.Text>().text = itemName;
    }

    public void HideItemName(){
        Debug.Log("Mouse Left " + itemName);
        if (!itemController.isShowingItemText)
        {
            this.GetComponentInChildren<UnityEngine.UI.Text>().text = "";
            displayedItensNames = false;
        }
    }
